...
@interface HAKCurrentHeatingCoolingModeCharacteristic : HAKStringCharacteristic <HAKVersioning>
{
}
...
+ (id)identifiers;
@property(nonatomic) unsigned long long currentHeatingCoolingMode;
